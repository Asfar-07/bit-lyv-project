      ...
      <div className="container1">
        <div className="backDiv">
          <div className="container4" id="container4">
            {signup ? <h2>Sign Account</h2> : <h2>Login Account</h2>}
            <form
              onSubmit={(e) => {
                signup ? onHandleSignUp() : onHandleLogin();
                e.preventDefault();
              }}
            >
              <div>
                ...
                <input
                  ...
                  title="Password must be 8-15 characters with uppercase and lowercase letters"
                  onChange={(e) => {
        ...
        <div className="frontDiv">
          ...
          <h1>WELCOME BACK</h1>
          <p>
            We're thrilled to see you again. Please enter your credentials to
            access your account
          </p>
